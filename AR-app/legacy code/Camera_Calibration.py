...
def calibrate(showPics=True):
        ...
        if cornersFound == True:
            ...
            if showPics:
                cv.drawChessboardCorners(
                    imgBGR, (nRows, nCols), cornersRefind, cornersFound
                )
    ...
    # Calibrate Camera
    repError, camMatrix, distCoeff, revecs, tvecs = cv.calibrateCamera(
...
def removeDistortion(camMatrix, distCoeff):
    ...
    imgPath = os.path.join(
        root,
        "C:/Users/khanh/Desktop/IITM/DSA_ry/D06ss/Agu/captured Images/opencv_frame_8.png",
    )
