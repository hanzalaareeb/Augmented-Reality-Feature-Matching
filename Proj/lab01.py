...
camera_matrix = np.array([[517.47899846, 0, 339.53993095],
                           [0, 516.14745585, 254.62370406],
                           [0, 0, 1]], dtype=np.float32)
dist_coeffs = np.array([-7.97239195e-02,  7.24817070e-01,  1.19007636e-03,  2.54971485e-03, -1.25542576e+00], dtype=np.float32)
